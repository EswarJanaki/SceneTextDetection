...
sys.path.append(os.path.dirname('/content/drive/MyDrive/crnn.tf2_./CRNN.TF2/crnn/'))
...
model = keras.models.load_model(args.model, compile=False,custom_objects={'CTCLoss': CTCLoss,'SequenceAccuracy': SequenceAccuracy})
